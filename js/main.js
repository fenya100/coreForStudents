...
// МОДАЛЬНОЕ ОКНО
let openRegistration = document.querySelector('.banner__button');
let modalka = document.querySelector('.page__modal');
openRegistration.onclick = function() {
    modalka.style.display = "block";
}

let closeRegistration = document.querySelector('.modal__close');
let modalkaClose = document.querySelector('.page__modal');
closeRegistration.onclick = function() {
    modalkaClose.style.display = "none";
}
...
if (map) {
    ...
    var init = function() {
        ...
        var myPlacemark = new window.ymaps.Placemark(mapCoord, {
            hintContent: 'Never gonna say goodbye',
            balloonContent: 'Never gonna tell a lie and hurt you'
        }, {
